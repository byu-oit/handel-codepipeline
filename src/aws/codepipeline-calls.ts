...
async function createCodePipelineRole(accountId: string|number) {
...
async function createCodePipelineProject(accountId: string|number, pipelineProjectName: string, codePipelineBucketName: string, codePipelinePhases: AWS.CodePipeline.StageDeclaration[]): Promise<AWS.CodePipeline.PipelineDeclaration> {
