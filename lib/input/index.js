...
exports.getPipelineConfigForDeploy = function(args) {
    let configs = {};
    ...
    if (args && args.handelCodePipelineConfig) {
        configs.accountConfig = args.handelAccountConfig
        configs.pipelineToDeploy = args.pipeline
