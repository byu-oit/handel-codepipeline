...
exports.createPipeline = function (pipelineName, handelFile, accountConfig, pipelinePhases, codePipelineBucketName) {
...
exports.updatePipeline = function (pipelineName, handelFile, accountConfig, pipelinePhases, codePipelineBucketName) {
    const codePipeline = new AWS.CodePipeline({ apiVersion: '2015-07-09' });
    let projectName = handelFile.name;
    return iamCalls.getRole(CODEPIPELINE_ROLE_NAME)
        .then(codePipelineRole => {
            let pipelineConfig = getPipelineConfig(projectName, codePipelineBucketName, pipelinePhases, codePipelineRole);
