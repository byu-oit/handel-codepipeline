...
function getProjectParams(projectName, handelFileName, imageName, environmentVariables, accountId, serviceRoleArn, region, buildSpec) {
    let projectParams = {
        name: projectName,
    ...
    projectParams.environment.environmentVariables.push(getCodeBuildEnvVarDef("HANDEL_PIPELINE_NAME", handelFileName));
...
exports.createProject = function (projectName, handelFileName, imageName, environmentVariables, accountId, serviceRoleArn, region, buildSpec) {
    ...
    let projectParams = getProjectParams(projectName, handelFileName, imageName, environmentVariables, accountId, serviceRoleArn, region, buildSpec);
...
exports.updateProject = function (projectName, handelFileName, imageName, environmentVariables, accountId, serviceRoleArn, region, buildSpec) {
    const codeBuild = new AWS.CodeBuild({ apiVersion: '2016-10-06' });
    let projectParams = getProjectParams(projectName, handelFileName, imageName, environmentVariables, accountId, serviceRoleArn, region, buildSpec);
